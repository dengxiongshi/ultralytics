...
source_folder = Path(r"H:\datasets\train_data")
images_folder_path = [source_folder / "images/train",
                      source_folder / "images/val",
                      source_folder / "images/test"]
labels_folder_path = [source_folder / "labels/train",
                      source_folder / "labels/val",
                      source_folder / "labels/test"]
classes = ["Danio rerio", "Pterophyllum scalare"]
